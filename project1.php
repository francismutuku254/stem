...
<head>
  ...
  <title>Novatech | Moving Rover (WeDo)</title>
  <link rel="icon" type="image/x-icon" href="img/image1.png">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">

  <style>
    /* Reuse RESET and HEADER styles from homepage */
...
<body>
  ...
  <!-- MAIN CONTENT -->
  <main>
    <h1>Project 1: Moving Rover (WeDo)</h1>
    ...
    <section class="steps">
      ...
      <ol>
        <li>Gather all LEGO WeDo parts needed for the rover.</li>
        <li>Assemble the base structure using wheels and connectors.</li>
        <li>Attach the motor to drive the wheels.</li>
        <li>Connect the motor to the WeDo hub.</li>
        <li>Upload or run the provided code to control movement.</li>
        <li>Test the rover and adjust if necessary.</li>
      </ol>
    </section>
...
# LEGO WeDo Python Example (pseudo-code)
import wedo

hub = wedo.connect()
motor = hub.motorA

motor.start(100)   # move forward
wedo.wait(2)       # run for 2 seconds
motor.stop()
      </pre>
    </section>
    ...
    <!-- Final Notes -->
    <div class="notes">
      <strong>Note:</strong> This project introduces basic motion using LEGO WeDo.  
      Try experimenting with different motor speeds or adding sensors for more interactivity!
    </div>
  </main>
  ...
  <script>
    ...
    function downloadCode() {
      ...
      link.download = "project1_code.py";
      link.click();
    }
  </script>
</body>
