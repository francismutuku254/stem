...
<head>
  ...
  <style>
    ...
    * { margin: 0; 
    ...
    @media (max-width: 768px) {
      .banner { font-size: 1.2rem; min-height: 70px; padding: 30px 15px; }
    }

    @media (max-width: 480px) {
      .banner { font-size: 1rem; min-height: 60px; padding: 25px 10px; }
    }
    ...
    @media (max-width: 480px) {
      .footer-content { font-size: 0.75rem; gap: 4px; }
    }
