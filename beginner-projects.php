...
<head>
  ...
  <title>Novatech | Beginner Projects</title>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; font-family: "Segoe UI", Arial, sans-serif; }
    ...
    .card img {
      ...
      background: #f0f0f0;   /* Fills empty space */
      display: block;
    }
    .card-content {
      padding: 20px;
    ...
    .card-content h3 {
      color: #03009dff; margin-bottom: 10px;
    }
    .card-content p {
      flex: 1;
      margin-bottom: 15px;
...
<body>
  ...
  <main>
    ...
    <div class="projects-grid">
      <div class="card">
        <img src="img/blink.jpg" alt="Blinking LED">
        <div class="card-content">
          <h3>Blinking LED</h3>
          <p>Learn how to make an LED blink using Arduino — the classic first project for beginners.</p>
        </div>
      </div>

      <div class="card">
        <img src="img/traffic.jpg" alt="Traffic Light">
        <div class="card-content">
          <h3>Traffic Light</h3>
          <p>Simulate traffic signals using LEDs and simple timing code. A fun intro to sequencing.</p>
        </div>
      </div>

      <div class="card">
        <img src="img/buzzer.jpg" alt="Buzzer Alert">
        <div class="card-content">
          <h3>Buzzer Alert</h3>
          <p>Build a small alarm system using a buzzer — perfect for learning digital outputs.</p>
        </div>
      </div>

      <div class="card">
        <img src="img/button.png" alt="Button Controlled LED">
        <div class="card-content">
          <h3>Button Controlled LED</h3>
          <p>Control an LED with a push button. A beginner’s step into inputs and outputs.</p>
        </div>
      </div>
    </div>
  </main>
